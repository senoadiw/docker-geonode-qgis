...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'docker_geonode.urls')
...
SITENAME = os.getenv('SITENAME', "docker_geonode")
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'docker_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, docker_geonode',
